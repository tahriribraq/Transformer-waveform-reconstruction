...
_Figure 1. Transformer-based canopy profile reconstruction architecture. Example input LVIS and ground-truth ALS waveforms are shown from a real paired observation. The predicted ALS waveform is illustrated by recoloring the ground truth for visualization purposes._ 
